      ...
      <header className="border-b border-[var(--border)] px-6 py-6">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="font-display text-2xl text-[var(--text-muted)]">Zona De Pix</p>
          </div>
        ...
        <h1 className="mt-1 font-display text-3xl text-[var(--text-primary)]">Panel de control general</h1>
      </header>
        ...
        {ITEMS.map((item) => (
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-display text-sm text-[var(--text-primary)]">{item.titulo}</p>
