      ...
      pw.MultiPage(
        ...
        build: (ctx) => [
          ...
          pw.TableHelper.fromTextArray(
            ...
            headers: ['FECHA', 'CANT.', 'PRODUCTO / SERVICIO', 'P. UNIT.', 'P. TOTAL'],
            data: [
              ...
              pw.Container(
                ...
                child: pw.Column(
                  children: [
                    ...
                    _filaTotal('TOTAL ABONADO',
                        '- ${_fmt(resumen.totalAbonado)}',
                        color: _verdeTexto),
